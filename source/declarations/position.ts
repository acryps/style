...
// inset type
export type InsetType = Length | Percentage | Variable<InsetType> | Calculation<Partial<InsetType>>;
...
export const left = (offset: InsetType) => new LeftStyleProperty(offset);
...
export const right = (offset: InsetType) => new RightStyleProperty(offset);
...
export const top = (offset: InsetType) => new TopStyleProperty(offset);
...
export const bottom = (offset: InsetType) => new BottomStyleProperty(offset);

export function insetInline(left: LeftStyleProperty, right: RightStyleProperty): InsetInlineStyleProperty
export function insetInline(leftOffset: InsetType, rightOffset: InsetType): InsetInlineStyleProperty
export function insetInline(offset: InsetType): InsetInlineStyleProperty
...
export function insetBlock(topOffset: InsetType, bottomOffset: InsetType): InsetBlockStyleProperty
export function insetBlock(offset: InsetType): InsetBlockStyleProperty
...
export function inset(leftOffset: InsetType, rightOffset: InsetType): InsetStyleProperty
export function inset(offset: InsetType): InsetStyleProperty
