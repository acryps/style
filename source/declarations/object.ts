...
export type ObjectPositionInlineDirection = 'left' | 'center' | 'right' | Percentage | Length;

// object position block direction
export type ObjectPositionBlockDirection = 'top' | 'center' | 'bottom' | 'left' | 'right' | Percentage | Length;
